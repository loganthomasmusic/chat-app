...
const CustomActions = ({
    ...
    // Generates unique ref for image based on user ID, current timestamp and image name
    ...
    // Upload image to firebase storage and send URL
    const uploadAndSendImage = async (imageURI) => {
        ...
        uploadBytes(newUploadRef, blob).then(async (snapshot) => {
            ...
            onSend([
                {
                    // _id: autogenerated ID by Firebase if don't supply an ID
